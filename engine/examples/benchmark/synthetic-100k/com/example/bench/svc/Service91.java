...
public class Service91 {
    ...
    public String apply_1(String arg) {
    ...
    public String compute_13(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_91_13";
    }
    ...
    public String compute_19(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_91_19";
    }
    ...
    private String config_val_1 = "default_val_91";
    private String config_val_2 = "another_val_91";
    private int counter_91 = 0;
    private static final String VERSION_91 = "v1.0.91";
    private final Service90 dep_91 = new Service90();
}
