...
public class Service160 {
    ...
    public String handleRequest_3(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service159().handleRequest_3(arg);
        return "ok_160_3";
    }
    ...
    public String processData_7(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service159().processData_7(arg);
        return "ok_160_7";
    }
    ...
    public String execute_9(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_160_9";
    }
    ...
    @GetMapping("/api/svc160/m11")
    public String processData_11(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service159().processData_11(arg);
        return "ok_160_11";
    }
    ...
    public String retrieve_16(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service159().retrieve_16(arg);
        return "ok_160_16";
    }
    ...
    public String query_20(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_160_20";
    }
    ...
    private String config_val_1 = "default_val_160";
    private String config_val_2 = "another_val_160";
    private int counter_160 = 0;
    private static final String VERSION_160 = "v1.0.160";
    private final Service159 dep_160 = new Service159();
}
