...
public class Service320 {
    ...
    public String convert_2(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
    ...
    public String convert_3(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service319().convert_3(arg);
        return "ok_320_3";
    }
    ...
    public String convert_11(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_320_11";
    }
    ...
    @GetMapping("/api/svc320/m12")
    public String retrieve_12(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service319().retrieve_12(arg);
        return "ok_320_12";
    }
    ...
    public String resolve_15(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service319().resolve_15(arg);
        return "ok_320_15";
    }
    ...
    public String aggregate_21(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service319().aggregate_21(arg);
        return "ok_320_21";
    }
    ...
    private String config_val_1 = "default_val_320";
    private String config_val_2 = "another_val_320";
    private int counter_320 = 0;
    private static final String VERSION_320 = "v1.0.320";
    private final Service319 dep_320 = new Service319();
}
