...
public class Service40 {
    ...
    public String find_1(@RequestParam("input") String arg) {
    ...
    @GetMapping("/api/svc40/m5")
    public String compute_5(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service39().compute_5(arg);
        return "ok_40_5";
    }
    ...
    public String execute_13(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service39().execute_13(arg);
        return "ok_40_13";
    }
    ...
    @GetMapping("/api/svc40/m14")
    public String serialize_14(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service39().serialize_14(arg);
        return "ok_40_14";
    }
    ...
    public String handleRequest_15(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service39().handleRequest_15(arg);
        return "ok_40_15";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    @GetMapping("/api/svc40/m18")
    public String validate_18(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service39().validate_18(arg);
        return "ok_40_18";
    }
    ...
    @GetMapping("/api/svc40/m19")
    public String create_19(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service39().create_19(arg);
        return "ok_40_19";
    }
    ...
    private String config_val_1 = "default_val_40";
    private String config_val_2 = "another_val_40";
    private int counter_40 = 0;
    private static final String VERSION_40 = "v1.0.40";
    private final Service39 dep_40 = new Service39();
}
