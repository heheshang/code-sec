...
public class Service460 {
    ...
    public String serialize_3(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_460_3";
    }
    ...
    public String aggregate_12(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service459().aggregate_12(arg);
        return "ok_460_12";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    @GetMapping("/api/svc460/m13")
    public String apply_13(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service459().apply_13(arg);
        return "ok_460_13";
    }
    ...
    public String handleRequest_15(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service459().handleRequest_15(arg);
        return "ok_460_15";
    }
    ...
    private String config_val_1 = "default_val_460";
    private String config_val_2 = "another_val_460";
    private int counter_460 = 0;
    private static final String VERSION_460 = "v1.0.460";
    private final Service459 dep_460 = new Service459();
}
