...
public class Service10 {
    ...
    @GetMapping("/api/svc10/m1")
    public String serialize_1(@RequestParam("input") String arg) {
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    public String handleRequest_2(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service9().handleRequest_2(arg);
        return "ok_10_2";
    }
    ...
    public String create_3(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_10_3";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    @GetMapping("/api/svc10/m7")
    public String getResult_7(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_10_7";
    }
    ...
    public String handleRequest_9(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service9().handleRequest_9(arg);
        return "ok_10_9";
    }
    ...
    public String load_10(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_10_10";
    }
    ...
    public String execute_11(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_10_11";
    }
    ...
    public String delete_18(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service9().delete_18(arg);
        return "ok_10_18";
    }
    ...
    private String config_val_1 = "default_val_10";
    private String config_val_2 = "another_val_10";
    private int counter_10 = 0;
    private static final String VERSION_10 = "v1.0.10";
    private final Service9 dep_10 = new Service9();
}
