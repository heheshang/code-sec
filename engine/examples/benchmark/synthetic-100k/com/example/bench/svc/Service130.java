...
public class Service130 {
    ...
    public String apply_1(@RequestParam("input") String arg) {
    ...
    public String handleRequest_3(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_130_3";
    }
    ...
    @GetMapping("/api/svc130/m6")
    public String convert_6(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service129().convert_6(arg);
        return "ok_130_6";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    public String fetch_8(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service129().fetch_8(arg);
        return "ok_130_8";
    }
    ...
    public String apply_10(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_130_10";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    public String handleRequest_11(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service129().handleRequest_11(arg);
        return "ok_130_11";
    }
    ...
    @GetMapping("/api/svc130/m19")
    public String handleRequest_19(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service129().handleRequest_19(arg);
        return "ok_130_19";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    public String transform_21(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_130_21";
    }
    ...
    private String config_val_1 = "default_val_130";
    private String config_val_2 = "another_val_130";
    private int counter_130 = 0;
    private static final String VERSION_130 = "v1.0.130";
    private final Service129 dep_130 = new Service129();
}
