...
public class Service120 {
    ...
    @GetMapping("/api/svc120/m3")
    public String retrieve_3(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service119().retrieve_3(arg);
        return "ok_120_3";
    }
    ...
    public String getResult_4(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service119().getResult_4(arg);
        return "ok_120_4";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    public String convert_5(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_120_5";
    }
    ...
    public String resolve_9(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_120_9";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    @GetMapping("/api/svc120/m11")
    public String getResult_11(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_120_11";
    }
    ...
    public String query_14(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service119().query_14(arg);
        return "ok_120_14";
    }
    ...
    @GetMapping("/api/svc120/m16")
    public String validate_16(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_120_16";
    }
    ...
    public String handleRequest_20(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_120_20";
    }
    ...
    private String config_val_1 = "default_val_120";
    private String config_val_2 = "another_val_120";
    private int counter_120 = 0;
    private static final String VERSION_120 = "v1.0.120";
    private final Service119 dep_120 = new Service119();
}
