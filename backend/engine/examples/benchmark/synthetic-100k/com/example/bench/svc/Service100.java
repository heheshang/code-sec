...
public class Service100 {
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    @GetMapping("/api/svc100/m4")
    public String handleRequest_4(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service99().handleRequest_4(arg);
        return "ok_100_4";
    }
    ...
    public String resolve_8(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_100_8";
    }
    ...
    @GetMapping("/api/svc100/m10")
    public String find_10(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_100_10";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    public String apply_12(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_100_12";
    }
    ...
    public String find_15(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_100_15";
    }
    ...
    private String config_val_1 = "default_val_100";
    private String config_val_2 = "another_val_100";
    private int counter_100 = 0;
    private static final String VERSION_100 = "v1.0.100";
    private final Service99 dep_100 = new Service99();
}
