...
public class Service110 {
    ...
    @GetMapping("/api/svc110/m6")
    public String load_6(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service109().load_6(arg);
        return "ok_110_6";
    }
    ...
    public String aggregate_8(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service109().aggregate_8(arg);
        return "ok_110_8";
    }
    ...
    @GetMapping("/api/svc110/m11")
    public String delete_11(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service109().delete_11(arg);
        return "ok_110_11";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    @GetMapping("/api/svc110/m12")
    public String find_12(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service109().find_12(arg);
        return "ok_110_12";
    }
    ...
    public String validate_16(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service109().validate_16(arg);
        return "ok_110_16";
    }
    ...
    public String validate_18(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_110_18";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    public String delete_20(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_110_20";
    }
    ...
    private String config_val_1 = "default_val_110";
    private String config_val_2 = "another_val_110";
    private int counter_110 = 0;
    private static final String VERSION_110 = "v1.0.110";
    private final Service109 dep_110 = new Service109();
}
