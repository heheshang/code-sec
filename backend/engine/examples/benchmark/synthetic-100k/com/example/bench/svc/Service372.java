...
public class Service372 {
    ...
    public String convert_17(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_372_17";
    }
    ...
    private String config_val_1 = "default_val_372";
    private String config_val_2 = "another_val_372";
    private int counter_372 = 0;
    private static final String VERSION_372 = "v1.0.372";
    private final Service371 dep_372 = new Service371();
}
