...
public class Service280 {
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    public String compute_3(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_280_3";
    }
    ...
    public String validate_6(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_280_6";
    }
    ...
    public String validate_9(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service279().validate_9(arg);
        return "ok_280_9";
    }
    ...
    public String handleRequest_10(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_280_10";
    }
    ...
    @GetMapping("/api/svc280/m13")
    public String retrieve_13(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service279().retrieve_13(arg);
        return "ok_280_13";
    }
    ...
    @GetMapping("/api/svc280/m14")
    public String find_14(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_280_14";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    public String find_15(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_280_15";
    }
    ...
    private String config_val_1 = "default_val_280";
    private String config_val_2 = "another_val_280";
    private int counter_280 = 0;
    private static final String VERSION_280 = "v1.0.280";
    private final Service279 dep_280 = new Service279();
}
