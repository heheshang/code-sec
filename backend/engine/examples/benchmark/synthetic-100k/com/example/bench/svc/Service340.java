...
public class Service340 {
    ...
    @GetMapping("/api/svc340/m4")
    public String delete_4(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_340_4";
    }
    ...
    @GetMapping("/api/svc340/m6")
    public String load_6(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service339().load_6(arg);
        return "ok_340_6";
    }
    ...
    public String transform_9(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_340_9";
    }
    ...
    public String validate_13(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_340_13";
    }
    ...
    public String validate_14(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_340_14";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    public String aggregate_17(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service339().aggregate_17(arg);
        return "ok_340_17";
    }
    ...
    public String find_18(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service339().find_18(arg);
        return "ok_340_18";
    }
    ...
    public String query_19(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service339().query_19(arg);
        return "ok_340_19";
    }
    ...
    private String config_val_1 = "default_val_340";
    private String config_val_2 = "another_val_340";
    private int counter_340 = 0;
    private static final String VERSION_340 = "v1.0.340";
    private final Service339 dep_340 = new Service339();
}
