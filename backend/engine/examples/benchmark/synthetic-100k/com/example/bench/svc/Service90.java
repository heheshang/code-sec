...
public class Service90 {
    ...
    public String apply_2(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
    ...
    @GetMapping("/api/svc90/m3")
    public String handleRequest_3(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service89().handleRequest_3(arg);
        return "ok_90_3";
    }
    ...
    public String aggregate_10(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_90_10";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    public String update_19(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_90_19";
    }
    ...
    public String getResult_20(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_90_20";
    }
    ...
    private String config_val_1 = "default_val_90";
    private String config_val_2 = "another_val_90";
    private int counter_90 = 0;
    private static final String VERSION_90 = "v1.0.90";
    private final Service89 dep_90 = new Service89();
}
