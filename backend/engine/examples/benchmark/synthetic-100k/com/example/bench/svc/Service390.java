...
public class Service390 {
    ...
    public String aggregate_4(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service389().aggregate_4(arg);
        return "ok_390_4";
    }
    ...
    public String execute_8(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_390_8";
    }
    ...
    public String update_9(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_390_9";
    }
    ...
    public String fetch_18(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_390_18";
    }
    ...
    private String config_val_1 = "default_val_390";
    private String config_val_2 = "another_val_390";
    private int counter_390 = 0;
    private static final String VERSION_390 = "v1.0.390";
    private final Service389 dep_390 = new Service389();
}
