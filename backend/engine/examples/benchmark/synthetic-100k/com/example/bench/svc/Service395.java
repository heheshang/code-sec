...
public class Service395 {
    ...
    public String find_7(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_395_7";
    }
    ...
    public String aggregate_11(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_395_11";
    }
    ...
    private String config_val_1 = "default_val_395";
    private String config_val_2 = "another_val_395";
    private int counter_395 = 0;
    private static final String VERSION_395 = "v1.0.395";
    private final Service394 dep_395 = new Service394();
}
