...
public class Service262 {
    ...
    public String delete_20(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_262_20";
    }
    ...
    private String config_val_1 = "default_val_262";
    private String config_val_2 = "another_val_262";
    private int counter_262 = 0;
    private static final String VERSION_262 = "v1.0.262";
    private final Service261 dep_262 = new Service261();
}
