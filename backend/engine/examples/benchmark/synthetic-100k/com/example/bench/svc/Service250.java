...
public class Service250 {
    ...
    @GetMapping("/api/svc250/m5")
    public String convert_5(String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service249().convert_5(arg);
        return "ok_250_5";
    }
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('USER')")
    @GetMapping("/api/svc250/m10")
    public String compute_10(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_250_10";
    }
    ...
    @GetMapping("/api/svc250/m12")
    public String load_12(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service249().load_12(arg);
        return "ok_250_12";
    }
    ...
    @GetMapping("/api/svc250/m17")
    public String getResult_17(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        return "ok_250_17";
    }
    ...
    @GetMapping("/api/svc250/m18")
    public String handleRequest_18(@RequestParam("input") String arg) {
        if (arg == null || arg.isEmpty()) { return "empty"; }
        System.out.println("Processing: " + arg);
        new Service249().handleRequest_18(arg);
        return "ok_250_18";
    }
    ...
    private String config_val_1 = "default_val_250";
    private String config_val_2 = "another_val_250";
    private int counter_250 = 0;
    private static final String VERSION_250 = "v1.0.250";
    private final Service249 dep_250 = new Service249();
}
